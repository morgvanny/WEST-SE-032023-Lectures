...
Revision ID: b95a0b47fd9b
Revises: 
Create Date: 2023-06-01 12:02:54.095953
...
def upgrade():
    ...
    sa.UniqueConstraint('planet_id', 'scientist_id', name=op.f('uq_missions_planet_id'))
    )
